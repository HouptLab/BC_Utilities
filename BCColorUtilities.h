...
enum color_menu_items  { NOFILLCOLOR = 0, 
		REDCOLOR, MAROONCOLOR, BROWNCOLOR,
		ORANGECOLOR, 
		YELLOWCOLOR, 
		OLIVECOLOR,LIMECOLOR, GREENCOLOR, 
		TEALCOLOR, AQUACOLOR, BLUECOLOR, NAVYCOLOR, 
		FUSCHIACOLOR, PURPLECOLOR,
		WHITECOLOR, SIVLERCOLOR, LIGHTGRAYCOLOR, GRAYCOLOR,DARKGRAYCOLOR, BLACKCOLOR };
